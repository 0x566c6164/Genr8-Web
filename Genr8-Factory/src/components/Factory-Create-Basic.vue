<template>
  ...
  <div id="container">
    <br>
    <form action="#" target="formDestination">
      <h1>App Creation</h1>
      <div class="question">
      ...
      <div class="question">
        <input id="SRevenue" type="text" required/>
        <label>Sell Revenue %</label>
      </div>
      <hr>
      <h3>Optional</h3>
      <div class="question">
        <input id="CCurrency" type="text"/>
        <label>Counter</label>
      </div>
      <div class="question">
      ...
      <button id="createBasic">Create</button>
    </form>
    <br>

    <iframe name="formDestination" style="visibility: hidden;"></iframe>
